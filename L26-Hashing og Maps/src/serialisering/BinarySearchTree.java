...
public class BinarySearchTree<E extends Comparable<E>> implements Serializable {
    ...
    /**
     * OPG 2
     * @return største element i træet
     */
    public E findMax() {
        return findMax(root);
    }
    ...
    /**
     * OPG 2
     * @return mindste element i træet
     */
    public E findMin() {
        return findMin(root);
    }
    ...
    /**
     * OPG 2
     * Fjerner mindste element i træet
     */
    public E removeMin() {
        return removeMin(root, null, false);
    }

    public E removeMin(Node n, Node p, Boolean found) {
        E returnData;
        if(n.left != null && !found) {
            returnData = removeMin(n.left, n, false);
        } else {
            found = true;
            returnData = n.data;
        }
    ...
    /**
     * OPG 2
     * Fjerner største element i træet
     */
    public E removeMax() {
        return removeMax(root, null, false);
    }

    public E removeMax(Node n, Node p, Boolean found) {
        E returnData;
        if(n.right != null && !found) {
            returnData = removeMax(n.right, n, false);
        } else {
            found = true;
            returnData = n.data;
        }
